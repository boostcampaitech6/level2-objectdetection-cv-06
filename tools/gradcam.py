...
class GradCAM_RetinaNet(object):
    ...
    def __call__(self, data, index=0):
        ...
        res = self.get_bboxes(*outs, img_metas=img_metas, rescale=True)
...
class GradCAM_YOLOV3(object):
    ...
    def __call__(self, data, index=0):
        ...
        res = self.net.bbox_head.simple_test(feat, img_metas, rescale=True)
        score = res[0][0][index][4]
        ...
        **kwargs
        ...
        for img_id in range(len(img_metas)):
            ...
            if with_score_factors:
                ...
                score_factor_list = [None for _ in range(num_levels)]
            results = self.net.rpn_head._get_bboxes_single(
                cls_score_list,
                bbox_pred_list,
                score_factor_list,
                mlvl_priors,
