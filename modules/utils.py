...
def mean_average_precision(pred_boxes, true_boxes, iou_threshold=0.5, box_format="midpoint", num_classes=10):
    """
...
def convert_cellboxes(predictions, S=7):
    ...
    scores = torch.cat((predictions[..., 10].unsqueeze(0), predictions[..., 15].unsqueeze(0)), dim=0)
    ...
    best_confidence = torch.max(predictions[..., 10], predictions[..., 15]).unsqueeze(-1)
